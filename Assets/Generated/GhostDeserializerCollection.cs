...
public struct NetTestGhostDeserializerCollection : IGhostDeserializerCollection
{
        ...
        ref DataStreamReader reader, NetworkCompressionModel compressionModel)
    {
        ...
        {
            case 0:
                return GhostReceiveSystem<NetTestGhostDeserializerCollection>.InvokeDeserialize(m_CubeSnapshotDataFromEntity, entity, snapshot, baseline, baseline2,
        ...
        NetworkCompressionModel compressionModel)
    {
        switch (serializer)
        {
            case 0:
                ...
                m_CubeSnapshotDataNewGhosts.Add(GhostReceiveSystem<NetTestGhostDeserializerCollection>.InvokeSpawn<CubeSnapshotData>(snapshot, ref reader, compressionModel));
                break;
            default:
                throw new ArgumentException("Invalid serializer type");
        }
...
public struct EnableNetTestGhostReceiveSystemComponent : IComponentData
{}
public class NetTestGhostReceiveSystem : GhostReceiveSystem<NetTestGhostDeserializerCollection>
{
